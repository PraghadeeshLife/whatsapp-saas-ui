    ...
    return (
        <div className="min-h-screen bg-white font-sans selection:bg-indigo-100 selection:text-indigo-900 flex items-center justify-center p-4 md:p-6 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full -z-10">
                <div className="absolute top-[-10%] left-[-10%] w-[80%] md:w-[50%] h-[50%] bg-indigo-50/50 rounded-full blur-[80px] md:blur-[120px]"></div>
                <div className="absolute bottom-[-10%] right-[-5%] w-[60%] md:w-[40%] h-[40%] bg-teal-50/30 rounded-full blur-[60px] md:blur-[100px]"></div>
            </div>
            ...
            <div className="max-w-md w-full relative z-10">
                <div className="bg-white/80 backdrop-blur-xl rounded-[2rem] md:rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] p-8 md:p-12 border border-slate-100">
                    ...
                    <div className="text-center mb-8 md:mb-10">
                        <h1 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter uppercase mb-2">Welcome Back</h1>
                        <p className="text-slate-600 text-[9px] md:text-[10px] font-black uppercase tracking-widest leading-none">Log in to manage your business</p>
                    </div>
