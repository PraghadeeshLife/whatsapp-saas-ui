    ...
    return (
        <div className="min-h-screen bg-white font-sans selection:bg-indigo-100 selection:text-indigo-900 flex items-center justify-center px-6 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full -z-10">
                <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] bg-indigo-50/40 rounded-full blur-[120px]"></div>
                <div className="absolute bottom-[-10%] left-[-5%] w-[40%] h-[40%] bg-rose-50/20 rounded-full blur-[100px]"></div>
            </div>
            ...
            <div className="max-w-md w-full relative z-10">
                <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] p-12 border border-slate-100">
                    ...
                    <div className="text-center mb-10">
                        <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase mb-2">Initialize Account</h1>
                        <p className="text-slate-400 text-[10px] font-black uppercase tracking-widest leading-none">Start automating your operations today</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                            />
                            <p className="text-[9px] text-slate-300 font-black uppercase tracking-widest mt-2 pl-1">Minimum 6 characters</p>
                        </div>
